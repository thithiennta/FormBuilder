...
export default {
  ...
  created() {
    this.fullPadding = this.activeElement.properties.spacing.fullPadding;
    this.allSides = this.activeElement.properties.spacing.allSidesPadding;
    this.top = this.activeElement.properties.spacing.topPadding;
    this.left = this.activeElement.properties.spacing.leftPadding;
    this.right = this.activeElement.properties.spacing.rightPadding;
    this.bottom = this.activeElement.properties.spacing.bottomPadding;
  },
  computed: {
