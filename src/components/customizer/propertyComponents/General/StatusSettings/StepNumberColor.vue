<template>
  <div class="property-wrapper">
    <div class="customizer-sub-sub-title">Step Number Color</div>
...
export default {
  ...
  created() {
    this.color = this.activeElement.properties.step[this.type + "NumberColor"];
  },
  mounted() {
    document.addEventListener("click", (e) => {
      var colorPicker = document.getElementById("step-number-sketch");
  ...
  watch: {
    ...
    type() {
      this.color = this.activeElement.properties.step[
        this.type + "NumberColor"
      ];
    },
    activeElement() {
      this.color = this.activeElement.properties.step[
  ...
  methods: {
    ...
    updateValue({ rgba }) {
      ...
      this.activeElement.properties.step[
        this.type + "NumberColor"
      ] = this.color;
    },
  },
